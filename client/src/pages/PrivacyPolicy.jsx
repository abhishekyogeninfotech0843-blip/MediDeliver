    ...
    <div className="privacy-page">
      ...
      <header className="privacy-header">
        <div className="privacy-header-container">
          ...
          <nav className="privacy-nav-links">
            ...
            <Link to="/privacy-policy" className="nav-item active">
              Privacy Policy
            </Link>
          </nav>
      ...
      <section className="privacy-hero">
        <div className="privacy-hero-content">
          ...
          <h1>
            MediDeliver <span>Privacy Policy</span>
          </h1>
          <p>
            Your health and personal data security is our utmost priority. Learn
            how MediDeliver collects, utilizes, protects, and handles your
            medical information and prescriptions in accordance with Indian
            Digital Health & IT laws.
          </p>
          <div className="policy-meta-tags">
            <span className="meta-tag">
              <Clock className="tag-ico" /> Effective Date: September 2026
            </span>
            <span className="meta-tag">
              <Lock className="tag-ico" /> 256-Bit SSL Encrypted
            </span>
            <span className="meta-tag">
              <CheckCircle2 className="tag-ico" /> Verified Pharmacist
              Compliance
            </span>
          </div>
        </div>
        ...
        <div className="trust-pills-strip">
          <div className="trust-pill-card">
            ...
            <div>
              ...
              <small>
                Prescriptions & user data encrypted in transit and at rest.
              </small>
            </div>
          </div>
          ...
          <div className="trust-pill-card">
            ...
            <div>
              ...
              <small>
                We strictly NEVER sell your personal or medical data to
                advertisers.
              </small>
            </div>
          </div>
          ...
          <div className="trust-pill-card">
            ...
            <div>
              ...
              <small>
                Secure payments processed via certified Razorpay gateways.
              </small>
            </div>
          </div>
          ...
          <div className="trust-pill-card">
            ...
            <div>
              ...
              <small>
                Easy access to update or request deletion of your profile data.
              </small>
            </div>
          </div>
        </div>
        ...
        <div className="privacy-layout">
          ...
          <main className="privacy-articles">
            ...
            <article id="overview" className="policy-section">
              ...
              <p>
                Welcome to <strong>MediDeliver</strong> ("we", "our", or "us").
                We operate an online pharmaceutical delivery marketplace and
                healthcare fulfillment service. We recognize that medical
                information is deeply personal and sensitive. This Privacy
                Policy outlines our uncompromising dedication to safeguarding
                your identity, medical prescriptions, location data, and
                financial transactions.
              </p>
              <p>
                By accessing our website, mobile interface, or using our
                medicine delivery services, you acknowledge that you have read
                and understood the terms of this Privacy Policy and consent to
                the collection and use of your data as described herein.
              </p>
            </article>
            ...
            <article id="data-collected" className="policy-section">
              ...
              <p>
                To provide seamless and safe medicine delivery, we collect the
              ...
              <div className="info-cards-list">
                <div className="info-detail-box">
                  ...
                  <p>
                    Full name, mobile phone number, email address, and account
                    login credentials.
                  </p>
                </div>
                ...
                <div className="info-detail-box">
                  ...
                  <p>
                    Delivery house/flat address, landmark, PIN code, and GPS
                    coordinates provided by you to enable express 15-45 minute
                    doorstep delivery.
                  </p>
                </div>
                ...
                <div className="info-detail-box">
                  ...
                  <p>
                    Prescription images, doctor's name, patient name, prescribed
                    medication dosages, and order claim notes uploaded for
                    verification.
                  </p>
                </div>
                ...
                <div className="info-detail-box">
                  ...
                  <p>
                    Ordered medicine names, quantities, invoice numbers, return
                    requests, and Razorpay payment transaction identifiers.
                  </p>
                </div>
              </div>
            </article>
            ...
            <article id="prescription-privacy" className="policy-section">
              ...
              <div className="highlight-callout green">
                ...
                <div>
                  <strong>
                    Doctor-Patient Privilege & Pharmacist Verification
                  </strong>
                  <p>
                    Prescriptions uploaded to MediDeliver are accessed
                    exclusively by licensed and registered pharmacists for the
                    sole purpose of verifying medication authenticity, dosage
                    accuracy, and fulfilling legally compliant pharmacy orders.
                  </p>
                </div>
              </div>
              <p>
                We do not index or expose medical prescriptions to
                non-authorized third parties. All uploaded prescription images
                are encrypted using industry-standard AES-256 encryption
                protocols.
              </p>
            </article>
            ...
            <article id="how-we-use" className="policy-section">
              ...
              <p>
                We use your data strictly for legitimate healthcare and order
                fulfillment operations:
              </p>
              <ul className="policy-bullet-list">
                <li>
                  <strong>Order Processing & Fulfillment:</strong> Verifying
                  order details, coordinating with certified inventory hubs, and
                  dispatching medicines to your saved address.
                </li>
                <li>
                  <strong>Prescription Validation:</strong> Ensuring compliance
                  with the Drugs and Cosmetics Act and pharmacy regulations.
                </li>
                <li>
                  <strong>Customer Support & Return Management:</strong>{" "}
                  Responding to tickets, tracking claims, and processing refunds
                  for return claims.
                </li>
                <li>
                  <strong>Delivery Notifications:</strong> Sending SMS/Email
                  alerts regarding order confirmation, dispatch,
                  out-for-delivery updates, and OTPs.
                </li>
                <li>
                  <strong>Platform Security & Fraud Prevention:</strong>{" "}
                  Preventing malicious activity, bot attacks, and fraudulent
                  payment claims.
                </li>
              </ul>
            </article>
            ...
            <article id="data-sharing" className="policy-section">
              ...
              <p>
                MediDeliver maintains a strict zero-compromise policy regarding
                user privacy:
              </p>
              <div className="policy-table-wrapper">
                <table className="policy-table">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <strong>Licensed Chemists / Fulfillment Hubs</strong>
                      </td>
                      <td>
                        Packaging genuine medicines and verifying batch codes.
                      </td>
                      <td>Prescription, Medicine Name, Patient Name</td>
                    </tr>
                    <tr>
                      <td>
                        <strong>Delivery Fleet Partners</strong>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        Processing encrypted online transactions and refunds.
                      </td>
                      <td>Order Amount, Transaction Ref, User Email</td>
                    </tr>
                    <tr>
                      <td>
                        <strong>Government / Legal Authorities</strong>
                      </td>
                      <td>
                        Only if mandated by applicable law or judicial court
                        order.
                      </td>
            ...
            <article id="payment-security" className="policy-section">
              ...
              <p>
                All online transactions on MediDeliver are processed through{" "}
                <strong>Razorpay</strong>, an RBI-authorized and PCI-DSS Level 1
                compliant payment gateway partner.
              </p>
              <div className="highlight-callout blue">
                ...
                <div>
                  ...
                  <p>
                    MediDeliver does not collect, store, or have access to your
                    full credit/debit card numbers, CVVs, net-banking passwords,
                    or UPI MPINs. All sensitive financial exchanges take place
                    directly through bank-grade 256-bit SSL encrypted channels.
                  </p>
                </div>
              </div>
            </article>
            ...
            <article id="cookies" className="policy-section">
              ...
              <p>
                We use browser session tokens and local storage solely to keep
                you securely logged in, remember your selected delivery
                zone/address, and maintain items in your active shopping cart.
                You can manage or disable cookies via your browser settings at
                any time.
              </p>
            </article>
            ...
            <article id="user-rights" className="policy-section">
              ...
              <p>
                As a MediDeliver user, you have complete sovereignty over your
                information:
              </p>
              <ul className="policy-bullet-list">
                <li>
                  <strong>Access & Review:</strong> You can view your past
                  orders, delivery addresses, and personal profile details from
                  the Profile and My Orders sections.
                </li>
                <li>
                  <strong>Correction & Updates:</strong> You may edit your
                  contact details and delivery location at any time.
                </li>
                <li>
                  <strong>Account Deletion:</strong> You have the right to
                  request deletion of your account and associated personal data
                  by contacting our grievance officer.
                </li>
                <li>
                  <strong>Data Retention:</strong> We retain order invoices and
                  tax records for the statutory period required by Indian
                  taxation and pharmacy laws.
                </li>
              </ul>
            </article>
            ...
            <article id="grievance" className="policy-section">
              ...
              <p>
                ...
                Consumer Protection (E-Commerce) Rules, the name and contact
                details of our Grievance Officer are provided below:
              </p>
                ...
                <div className="officer-grid">
                  <div className="off-item">
                    ...
                    <div>
                      ...
                      <a href="mailto:privacy@medideliver.in">
                        privacy@medideliver.in
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="off-item">
                    ...
                    <div>
                      ...
                      <a href="tel:+918171915305">
                        +91 81719 15305 / +91 94571 55186
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="off-item">
                    ...
                    <div>
                      ...
                      <span>
                        MediDeliver Healthcare Hub, Ramghat Road, Aligarh, UP -
                        202001, India
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="off-item">
                    ...
                    <div>
                      ...
                      <strong>
                        Acknowledgment within 24 hours; Resolution within 48-72
                        hours
                      </strong>
                    </div>
                  </div>
